...
const headers = [
  ...
  { title: 'model.lot.releaseTime', key: 'releaseTime', type: 'datetime' },
  { title: 'model.lot.shipTime', key: 'shipTime', type: 'datetime' },
  { title: 'model.lot.trackInTime', key: 'trackInTime', type: 'datetime' },
  { title: 'model.lot.trackOutTime', key: 'trackOutTime', type: 'datetime' },
